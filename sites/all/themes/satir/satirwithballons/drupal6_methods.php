...
function satirwithballons_menu_local_task($link, $active = FALSE) {
  $active_class = "";
  if ($active) {
    $active_class .= "active ";
  }
 ...
 *   A descriptive title of the feed.
  */
function satirwithballons_feed_icon($url, $title) {
 ...
 */
function satirwithballons_preprocess_comment_wrapper(&$vars) {
