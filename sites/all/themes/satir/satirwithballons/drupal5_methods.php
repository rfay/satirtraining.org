...
function satirwithballons_regions() {
  return array(
'left' => t('Left sidebar'),
 ...
 * @ingroup themeable
 */
function satirwithballons_menu_local_task($mid, $active, $primary) {
  $active_class = "";
  if ($active) {
    $active_class .= "active ";
  }
 ...
 *   The url of the feed.
 */
function satirwithballons_feed_icon($url) {
 ...
 */
function satirwithballons_comment_wrapper($content, $type = null) {
  static $node_type;
