 ...
 */
function satirbasetheme_breadcrumb($breadcrumb) {
  if (!empty($breadcrumb)) {
    return '<div class="breadcrumb">'. implode(' | ', $breadcrumb) .'</div>';
  }
}

function satirbasetheme_service_links_node_format($links) {
 ...
 * @ingroup themeable
 */
function satirbasetheme_button($element) {
...
*/
function satirbasetheme_img_assist_page($content, $attributes = NULL) {
