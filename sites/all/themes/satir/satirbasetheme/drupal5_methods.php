...
function satirbasetheme_regions() {
  return array(
 ...
 * @ingroup themeable
 */
function satirbasetheme_menu_local_task($mid, $active, $primary) {
  $active_class = "";
  if ($active) {
    $active_class .= "active ";
  }
 ...
 *   The url of the feed.
 */
function satirbasetheme_feed_icon($url) {
 ...
 */
function satirbasetheme_comment_wrapper($content, $type = null) {
  static $node_type;
