...
function satirbasetheme_menu_local_task($link, $active = FALSE) {
  $active_class = "";
  if ($active) {
    $active_class .= "active ";
  }
 ...
 *   A descriptive title of the feed.
  */
function satirbasetheme_feed_icon($url, $title) {
 ...
 */
function satirbasetheme_preprocess_comment_wrapper(&$vars) {
